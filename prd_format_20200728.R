...
prd_format <- function(workbook, tables, output_sheet_names = NULL, text_cols = NULL, font_size = 10,
                       ...
                       col_width_padding = 1, min_col_width = 8.43, overwrite = FALSE) {
        ...
        format_current_table <- function(workbook, current_table, current_output_sheet_name, 
                                         current_text_cols, current_font_size, current_summary_rows, current_summary_cols,
                                         ...
                                         current_col_width_padding, current_min_col_width, overwrite) {
                ...
                # create header_style
                header_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                            fontColour = "#ffffff", fgFill = "#1F497D", numFmt = "GENERAL",
                ...
                body_string_odd_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                         fontColour = "#000000", fgFill = "#ffffff", numFmt = "GENERAL",
                                                         border = NULL, borderColour = NULL, borderStyle = NULL,
                                                         halign = "center", valign = "center", textDecoration = NULL, wrapText = TRUE)
                
                # create body_string_even_row_style
                body_string_even_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                          fontColour = "#000000", fgFill = "#D6E4F5", numFmt = "GENERAL",
                                                          border = NULL, borderColour = NULL, borderStyle = NULL,
                                                          halign = "center", valign = "center", textDecoration = NULL, wrapText = TRUE)
                ...
                body_numeric_odd_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                          fontColour = "#000000", fgFill = "#ffffff", numFmt = "GENERAL",
                                                          border = NULL, borderColour = NULL, borderStyle = NULL,
                                                          halign = "right", valign = "center", textDecoration = NULL, wrapText = TRUE)
                
                # create body_numeric_even_row_style
                body_numeric_even_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                           fontColour = "#000000", fgFill = "#D6E4F5", numFmt = "GENERAL",
                                                           border = NULL, borderColour = NULL, borderStyle = NULL,
                                                           halign = "right", valign = "center", textDecoration = NULL, wrapText = TRUE)
                ...
                body_first_col_odd_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                            fontColour = "#000000", fgFill = "#ffffff", numFmt = "GENERAL",
                                                            border = "right", borderColour = "#B2B2B2", borderStyle = "thick",
                                                            halign = "center", valign = "center", textDecoration = NULL, wrapText = TRUE)
                
                # create body_first_col_even_row_style
                body_first_col_even_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                             fontColour = "#000000", fgFill = "#D6E4F5", numFmt = "GENERAL",
                                                             border = "right", borderColour = "#B2B2B2", borderStyle = "thick",
                                                             halign = "center", valign = "center", textDecoration = NULL, wrapText = TRUE)
                ...
                body_last_row_first_col_odd_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                                     fontColour = "#000000", fgFill = "#ffffff", numFmt = "GENERAL",
                                                                     border = c("right", "bottom"), borderColour = "#B2B2B2", borderStyle = "thick",
                                                                     halign = "center", valign = "center", textDecoration = NULL, wrapText = TRUE)
                
                # create body_last_row_first_col_even_row_style
                body_last_row_first_col_even_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                                      fontColour = "#000000", fgFill = "#D6E4F5", numFmt = "GENERAL",
                                                                      border = c("right", "bottom"), borderColour = "#B2B2B2", borderStyle = "thick",
                                                                      halign = "center", valign = "center", textDecoration = NULL, wrapText = TRUE)
                
                # create body_last_row_numeric_odd_row_style
                body_last_row_numeric_odd_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                                   fontColour = "#000000", fgFill = "#ffffff", numFmt = "GENERAL",
                                                                   border = "bottom", borderColour = "#B2B2B2", borderStyle = "thick",
                                                                   halign = "right", valign = "center", textDecoration = NULL, wrapText = TRUE)
                
                # create body_last_row_numeric_even_row_style
                body_last_row_numeric_even_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                                    fontColour = "#000000", fgFill = "#D6E4F5", numFmt = "GENERAL",
                                                                    border = "bottom", borderColour = "#B2B2B2", borderStyle = "thick",
                                                                    halign = "right", valign = "center", textDecoration = NULL, wrapText = TRUE)
                
                # create body_last_row_string_odd_row_style
                body_last_row_string_odd_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                                  fontColour = "#000000", fgFill = "#ffffff", numFmt = "GENERAL",
                                                                  border = "bottom", borderColour = "#B2B2B2", borderStyle = "thick",
                                                                  halign = "center", valign = "center", textDecoration = NULL, wrapText = TRUE)
                
                # create body_last_row_string_even_row_style
                body_last_row_string_even_row_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size, 
                                                                   fontColour = "#000000", fgFill = "#D6E4F5", numFmt = "GENERAL",
                                                                   border = "bottom", borderColour = "#B2B2B2", borderStyle = "thick",
                                                                   halign = "center", valign = "center", textDecoration = NULL, wrapText = TRUE)
                ...
                footnote_style <- createStyle(fontName = "Source Sans Pro", fontSize = current_font_size - 1, 
                                              fontColour = "#000000", fgFill = "#ffffff", numFmt = "GENERAL",
                                              border = NULL, borderColour = NULL, borderStyle = NULL,
                ...
                # handle ovewrites if workbook already has worksheet with same name as current_output_sheet_name
                if((current_output_sheet_name %in% workbook$sheet_names) & (overwrite == TRUE)) {
                        workbook %>% removeWorksheet(sheet = current_output_sheet_name)
                }
                ...
                tailor_col_widths <- function(table, col_width_padding, min_col_width, font_size) {
                        
                        # get font_size_scaling
                        font_size_scaling <- case_when(font_size >= 11 ~ 1,
                                                       font_size == 10 ~ .9,
                                                       font_size == 9 ~ .9,
                                                       font_size == 8 ~ .8,
                                                       font_size <= 7 ~ .7)
                        ...
                        header_col_width_tbl <- str_replace_all(string = names(table), pattern = "\n", replacement = " ") %>% 
                                ...
                                mutate(header_best_col_width = case_when(header_max_word_length > (8 - (2 * font_size_scaling * col_width_padding)) ~ 
                                                                                 (header_max_word_length * font_size_scaling) + (2 * font_size_scaling * col_width_padding), 
                                                                         TRUE ~ min_col_width))
                        ...
                        body_col_width_tbl <- table %>% map(.x = ., .f = ~ max(nchar(.x))) %>% as_tibble() %>%
                                ...
                                mutate(body_best_col_width = case_when(body_max_nchar > (8 - (2 * font_size_scaling * col_width_padding)) ~ 
                                                                               (body_max_nchar * font_size_scaling) + (2 * font_size_scaling * col_width_padding), 
                                                                       TRUE ~ min_col_width))
                ...
                if(!is.null(current_custom_col_width)) {
                        ...
                        walk2(.x = 1:length(current_custom_col_width), 
                              .y = current_custom_col_width,
                              .f = ~ ifelse(is.na(.y), NA, setColWidths(wb = workbook, sheet = sheet, 
                                                                        cols = 1 + .x, widths = current_custom_col_width[.x])))
                }
                ...
                tailor_header_height <- function(table, col_width_padding, min_col_width, font_size) {
                        ...
                        # get header_line_height_scaling
                        header_line_height_scaling <- case_when(font_size >= 11 ~ 1,
                                                                font_size == 10 ~ .9,
                                                                font_size == 9 ~ .85,
                                                                font_size == 8 ~ .8,
                                                                font_size <= 7 ~ .75)
                        ...
                        organic_wrapped_lines_required <- overall_col_width_tbl %>% 
                                pull(var_name) %>% str_split(string = ., pattern = "\n") %>%
                                map2_dfr(.x = ., .y = overall_col_width_tbl %>% 
                                                 pull(overall_best_col_width),
                                         .f = ~ tibble(var_name_segments_btw_newlines = .x) %>% 
                                                 mutate(overall_best_col_width = .y,
                                                        overall_best_col_width_minus_padding = overall_best_col_width - (2 * col_width_padding * font_size_scaling), 
                                                        organic_wrapped_lines_required = ((nchar(var_name_segments_btw_newlines) * font_size_scaling) / 
                                                                                                  overall_best_col_width_minus_padding) - .2,
                        ...
                        best_header_height <- body_col_width_tbl %>% bind_cols(., organic_wrapped_lines_required) %>% 
                                ...
                                mutate(best_header_height = ((total_wrapped_lines_required * 15 * header_line_height_scaling) + (10 * font_size_scaling))) %>% 
                                distinct(best_header_height) %>%
                ...
                if(!is.null(current_style_table)) {
                        ...
                        # handle current_font_size
                        # note that any custom font_size passed in style_table will overwrite the global font_size argument
                        current_style_table <- tibble(row_type = c("header", "body", "footnote"), 
                                                      rows_from = rep(1, times = 3), 
                                                      rows_to = rep(nrow(current_table), times = 3),
                                                      cols_from = rep(1, times = 3),
                                                      cols_to = rep(ncol(current_table), times = 3),
                                                      font_name = NA,
                                                      font_size = c(current_font_size, current_font_size, current_font_size - 1),
                                                      font_color = NA,
                                                      border = NA,
                                                      border_color = NA,
                                                      border_style = NA,
                                                      background_fill = NA,
                                                      horizontal_alignment = NA,
                                                      vertical_alignment = NA,
                                                      text_decoration = NA,
                                                      wrap_text = NA,
                                                      text_rotation = NA) %>%
                                bind_rows(., current_style_table)
        ...
        # if no font_size is passed, set defaults
        if(is.null(font_size)) {
                font_size <- rep(10, times = length(tables))
        }
        ...
        # handle font_size if multiple tables are passed, but arg is only a single value
        if(length(tables) > 1 & length(font_size) == 1) {
                font_size <- rep(font_size, times = length(tables))
        }
        ...
        # handle superscript_table if it is not passed as a list 
        # (note if not a list, a data.frame/tibble is assumed - currently no support for passing superscript_table as a vector)
        # note the sum(class(superscript_table) == "list") == 0 code is needed to handle when class() is called on tibble and length of output is 3
        if(!is.null(superscript_table) & sum(class(superscript_table) == "list") == 0) {
                superscript_table <- list(superscript_table)
        }
        
        # handle superscript_table if superscript_table is not NULL, but more tables are passed than foonote_tables
        if(length(tables) > 1 & length(superscript_table) > 0 & length(superscript_table) < length(tables)) {
                superscript_table <- c(superscript_table, map(.x = (length(superscript_table) + 1):length(tables), .f = ~ NULL))
        }
